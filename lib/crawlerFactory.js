...
class CrawlerFactory {
  ...
  static addAmqpQueueToCrawler(name, crawlerService) {
    const queue = CrawlerFactory.createAmqpQueue(name, crawlerService.options.queuing);

    return crawlerService.crawler.queues.addQueue(queue)
  }

  static createAmqpQueue(name, options) {
    ...
    return manager.createQueueChain(name, tracker, options);
  }

  static deleteAmqpQueueFromCrawler(name, crawlerService) {
    return crawlerService.crawler.queues.deleteQueue(name)
  }
